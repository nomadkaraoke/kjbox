...
def load_config(config_file=None):
    ...
    defaults = {
        ...
        # How long a completed gen job waits for its NOMAD-#### master to arrive
        # via master-sync before falling back to a direct 720p download.
        "gen_master_wait_seconds": 600,
