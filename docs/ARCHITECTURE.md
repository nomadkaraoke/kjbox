...
| GET  | `/sing/event-info` | **PUBLIC** — footer context for the singer UI: KJ display name, free-text footer message, enabled pre-built notice keys (`footer_settings` from the Public Request Form modal) |
